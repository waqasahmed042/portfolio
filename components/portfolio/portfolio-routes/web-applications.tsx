...
const WebApplications: React.FC = () => {
    ...
    const [activeButton, setActiveButton] = useState<string>('Web Applications');
    ...
    // scroll to dashboard items
    useScrollToSection(dashboardSectionRef, '/portfolio/web-applications');
