...
const GoogleFormsAddons: React.FC = () => {
    ...
    const [activeButton, setActiveButton] = useState<string>('Google Form Add-ons');
    ...
    useScrollToSection(dashboardSectionRef, '/portfolio/google-forms-addons');
...
export default GoogleFormsAddons;