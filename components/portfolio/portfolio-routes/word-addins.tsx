...
import { buttonText, demoLoomURLs, word_addins } from '@/utilities/portfolio';
...
const WordAddins: React.FC = () => {
    ...
    const [activeButton, setActiveButton] = useState<string>('Word Add-ins');
    ...
    // scroll to word add-in items
    useScrollToSection(dashboardSectionRef, '/portfolio/word-addins');
