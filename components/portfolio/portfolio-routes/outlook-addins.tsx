...
import { buttonText, demoLoomURLs, outlook_addins } from '@/utilities/portfolio';
...
const OutlookAddins: React.FC = () => {
    ...
    const [activeButton, setActiveButton] = useState<string>('Outlook Add-ins');
    ...
    // scroll to outlook add-in items
    useScrollToSection(dashboardSectionRef, '/portfolio/outlook-addins');
